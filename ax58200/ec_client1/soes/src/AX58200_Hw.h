...
PROTO UINT32 HW_BitToNum(UINT32 Pin);
...
INT32 HW_MiiPhyRead(UINT8 PhyAddr, UINT8 RegAddr, UINT16 *pBuf, UINT8 Size);
INT32 HW_MiiPhyWrite(UINT8 PhyAddr, UINT8 RegAddr, UINT16 *pData, UINT8 Len);
